...
public class CarsPage extends BasePage {
    ...
    private final SelenideElement
            CARS_FIELD = $x("//a[text()='Cars']"),
            CARS_READ_FIELD = $x("//a[text()='Read all']"),
            CARS_RELOAD_FIELD = $x("//button[text()='Reload']"),
            ID_FIELD = $x("//button[contains(text(),'ID')]"),
            ID_UP_FIELD = $x("//button[text()='↑']"),
            CAR_CREATE_FIELD = $x("//a[text()='Create new']"),
            ...
            INVALID_MESSAGE = $x("//button[normalize-space()='Status: AxiosError: " +
                    "Request failed with status code 400']"),
            CAR_BUY_OR_SELL_FIELD = $x("//a[text()='Buy or sell car']");
