...
public class AddMoneyPage extends BasePage {
    ...
    private final SelenideElement  USER_ID_FIELD = $("#id_send");
    private final SelenideElement MONEY_FIELD = $("#money_send");
    private final SelenideElement PUSH_BUTTON = $("button.btn.btn-primary.tableButton");
    private final SelenideElement  SUCCESS_MESSAGE_200 = $x("//button[normalize-space()='Status: " +
            "Successfully pushed, code: 200']");
    private final SelenideElement INCORRECT_MESSAGE = $x("//button[normalize-space()='Status: " +
    ...
    public String getSuccessMessage() {
        ...
        return getText(SUCCESS_MESSAGE_200);
    }
