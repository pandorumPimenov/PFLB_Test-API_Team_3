...
public class LoginPage extends BasePage {
    private final SelenideElement SUBMIT_BUTTON = $x("//button[normalize-space(text()) = 'GO']");
    private final SelenideElement LOG_OUT_BUTTON = $x("//button[normalize-space(text()) = 'LOGOUT']");
    private final SelenideElement EMAIL_ERROR_MESSAGE = $(By.xpath("//div[@style='color: red;'][1]"));
    private final SelenideElement PASSWORD_ERROR_MESSAGE = $(By.xpath("//div[@style='color: red;'][2]"));
