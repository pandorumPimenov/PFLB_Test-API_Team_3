...
public class CreateUserPage extends BasePage {
    ...
    private final SelenideElement SUCCESS_MESSAGE_201 = $x("//button[normalize-space()='Status: Successfully pushed, code: 201']");
    private final SelenideElement INVALID_MESSAGE = $x("//button[normalize-space()='Status: Invalid request data']");
